...
```{r}
#--- Look at the dataset (note the capitalisation in View - R is case sensitive!) in the viewer 
View(iris)

```

the `View()` function makes an excel like spreadsheet pop up which is useful to work from. 

```{r}

names(iris) # this tells you the names of the columns. 
# In this case, the columns are the variables included 
# in the Iris dataset. This is probably the most useful 
# function for checking your dataset. 

ncol(iris) # this tells you how many columns the Iris 
# data set has (e.g. variables)

nrow(iris) # this tells you how many rows there are. 
# In this case this is the total sample size (e.g. observations)
...
Iris2 <-  iris[,1] 
# this is useful when you don’t know the names,
# or don’t what to type them. 
